...
public class ComplianceRuleEngineApplication {
    ...
    public static void main(String[] args) {
                ...
                ComplianceRule rule2 = new ComplianceRule("rule2", "Settings must be {...}", 
                		config -> config.getDeviceId().equals("{...}"));

               
        
      
        ComplianceService service = new ComplianceService(List.of(rule,rule2)); 
        Configuration config = new Configuration("device34", "xxyy");
